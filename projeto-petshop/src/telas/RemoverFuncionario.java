...
public class RemoverFuncionario extends javax.swing.JFrame {
    ...
    public RemoverFuncionario() {
        ...
        for(SuperClasse s: sc){
            if(s instanceof Funcionario){
                Object[] ob = {s.getCod(), ((Funcionario) s).getNome(), ((Funcionario) s).getCpf()};
                dtm.addRow(ob);
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Selecione um Funcinário");
                    ...
                    if(s instanceof Funcionario){
                        if(i == op){
                            ...
                            for(SuperClasse ss: sc){
                                if(ss instanceof Funcionario){
                                    Object[] ob = {ss.getCod(), ((Funcionario) ss).getNome(), 
                                        ((Funcionario) ss).getCpf()};
                                    dtm.addRow(ob);
                                }
                            }
                            jTable1.setModel(dtm);
